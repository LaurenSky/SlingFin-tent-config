...
class HasInnerTentBodies extends React.Component {
  checkForInnerTentBodies(props) {
    ...
    if ( partsInCart.includes('6') && partsInCart.includes('7') && partsInCart.includes('8') && partsInCart.includes('3')) {
      ...
      return <div><h4 className='normal'>Great, you added a RipStop Body to your configuration.</h4><h4 className='go-next-step'>Add a Mesh Body to have a 3-season tent too. <br /> - Or click on Footprints to go to the next step. -</h4></div>
