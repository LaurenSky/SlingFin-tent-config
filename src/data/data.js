  ...
  footprints: [
    {
      ...
      category: "FootPrint",
      name: "Tub Footprint",
      description: "SlingFin's patented TubFootprint actually keeps  water out --unlike flat tarps! Creates the StormPacksystem (the lightweight, fastpack configuration) when paired with fly, WebTruss and poles.",
      price: '34.90',
      weight: '245.00',
